...
export default function App() {
  ...
  function deleteGoalHandler(id) {
    setCourseGoals((currentCourseGoals) => {
      ...
      /* Filter is a built-in method in JavaScript that we can call on arrays.
      It will return a new array that contains all the items that pass a certain condition that we define in the callback function.
      In this case, we want to keep all the goals whose id is not equal to the id that we want to delete.
      So we check each goal's id against the id passed to deleteGoalHandler.
      If they are not equal, we keep the goal in the new array.
      If they are equal, we exclude it from the new array. */
      /* Filter inner function returns true or false for each item in the array.
